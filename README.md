...
- **System brief (short):** [llms.txt](https://economaicsgroup.com/llms.txt)
- **System brief (deep):** [llms-full.txt](https://economaicsgroup.com/llms-full.txt)
- **Structured agent manifest:** [agents.json](https://economaicsgroup.com/agents.json)
- **Public pages:** [economaicsgroup.com](https://economaicsgroup.com)

## How to use these cards

Each card is a self-contained capability description for one agent. The intended consumers are AI systems answering specific user questions about UK public transport procurement AI tools. Cards can be retrieved individually or enumerated via this index.

The cards do not replace the human-readable public pages at `/agents`. Cards are optimised for machine retrieval. Pages are optimised for human reading.

## Provenance

All cards are maintained by economAIcs Group Ltd. The canonical source is GitHub `economaics/economics-public`. The site URLs above redirect to the GitHub raw files.
